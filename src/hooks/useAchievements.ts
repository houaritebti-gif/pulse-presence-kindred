...
export const ACHIEVEMENTS: AchievementDefinition[] = [
  ...
  { key: 'super_spark_10', name: 'Electrizante', description: 'Envía 10 Super Chispas', icon: 'ZapOff', category: 'milestone', rarity: 'epic', energyReward: RARITY_ENERGY_REWARDS.epic },
