...
const cachedToPresence = (cached: CachedProfile): PresenceWithProfile => ({
  ...
  profile: {
    ...
    colored_hair: (cached.profile as any).colored_hair ?? null,
    shaved_head: (cached.profile as any).shaved_head ?? null,
    vintage_style: (cached.profile as any).vintage_style ?? null,
    gothic_style: (cached.profile as any).gothic_style ?? null,
    ...
    optional_details: (cached.profile as any).optional_details ?? null,
    show_optional_details: (cached.profile as any).show_optional_details ?? null,
  },
