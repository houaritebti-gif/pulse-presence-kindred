...
const sizeClasses = {
  sm: {
    text: "text-lg",
    heart: "w-2 h-2",
    heartPos: "-top-2.5 left-1/2 -translate-x-1/2",
    marginLeft: "",
    glow: false,
  },
  md: {
    ...
    heartPos: "-top-3 sm:-top-3.5 left-1/2 -translate-x-1/2",
    marginLeft: "",
    glow: false,
  },
  lg: {
    ...
    heartPos: "-top-3.5 sm:-top-4.5 left-1/2 -translate-x-1/2",
    marginLeft: "",
    glow: false,
  },
  xl: {
    ...
    heartPos: "-top-5 sm:-top-6 left-1/2 -translate-x-1/2",
    marginLeft: "",
    glow: true,
  },
  hero: {
    ...
    heartPos: "-top-6 md:-top-8 lg:-top-10 left-1/2 -translate-x-1/2",
    marginLeft: "",
    glow: true,
  },
};
