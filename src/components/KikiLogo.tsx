...
const sizeClasses = {
  ...
  md: {
    ...
    heartPos: "-top-2.5 sm:-top-3 left-0 sm:-left-0.5",
    marginLeft: "",
    glow: false,
  },
  lg: {
    ...
    heartPos: "-top-3 sm:-top-3.5 -left-0.5 sm:-left-0.5",
    marginLeft: "",
    glow: false,
  },
  xl: {
    ...
    heartPos: "-top-4 sm:-top-5 -left-0.5 sm:-left-1",
    marginLeft: "",
    glow: true,
  },
  hero: {
    ...
    heartPos: "-top-5 md:-top-6 lg:-top-8 -left-0.5 md:-left-1 lg:-left-1.5",
    marginLeft: "",
    glow: true,
  },
};
