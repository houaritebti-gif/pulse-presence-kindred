...
const sizeClasses = {
  ...
  md: {
    ...
    heartPos: "-top-1 sm:-top-1.5 -left-0.5 sm:-left-1",
    marginLeft: "",
    glow: false,
  },
  lg: {
    ...
    heartPos: "-top-1.5 sm:-top-2 -left-1 sm:-left-1",
    marginLeft: "",
    glow: false,
  },
  xl: {
    ...
    heartPos: "-top-2 sm:-top-2.5 -left-1 sm:-left-1.5",
    marginLeft: "",
    glow: true,
  },
  hero: {
    ...
    heartPos: "-top-2 md:-top-3 lg:-top-4 -left-1 md:-left-1.5 lg:-left-2",
    marginLeft: "",
    glow: true,
  },
};
