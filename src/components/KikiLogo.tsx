...
const sizeClasses = {
  ...
  md: {
    ...
    heartPos: "-top-3 sm:-top-3.5 -left-0.5 sm:-left-1",
    marginLeft: "",
    glow: false,
  },
  lg: {
    ...
    heartPos: "-top-3.5 sm:-top-4.5 -left-1 sm:-left-1.5",
    marginLeft: "",
    glow: false,
  },
  xl: {
    ...
    heartPos: "-top-5 sm:-top-6 -left-1.5 sm:-left-2",
    marginLeft: "",
    glow: true,
  },
  hero: {
    ...
    heartPos: "-top-6 md:-top-8 lg:-top-10 -left-2 md:-left-3 lg:-left-4",
    marginLeft: "",
    glow: true,
  },
};
