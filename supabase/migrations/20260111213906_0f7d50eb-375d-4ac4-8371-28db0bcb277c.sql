-- Add age range filter columns for new presence notifications
ALTER TABLE public.profiles 
ADD COLUMN IF NOT EXISTS notify_min_age INTEGER DEFAULT NULL,
ADD COLUMN IF NOT EXISTS notify_max_age INTEGER DEFAULT NULL;

-- Update the notification function to check age range
